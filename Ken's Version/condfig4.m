function varargout = condfig4(varargin)
%CONDFIG M-file for condfig4.fig
%      CONDFIG4, by itself, creates a new CONDFIG4 or raises the existing
%      singleton*.
%
%      H = CONDFIG4 returns the handle to a new CONDFIG4 or the handle to
%      the existing singleton*.
%
%      CONDFIG4('Property','Value',...) creates a new CONDFIG4 using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to CONDFIG_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      CONDFIG4('CALLBACK') and CONDFIG4('CALLBACK',hObject,...) call the
...
% Last Modified by GUIDE v2.5 23-Oct-2015 11:53:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @condfig4_OpeningFcn, ...
                   'gui_OutputFcn',  @condfig4_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
function condfig4_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = condfig4_OutputFcn(hObject, eventdata, handles)
