function varargout = onelayergui5(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @onelayergui5_OpeningFcn, ...
    'gui_OutputFcn',  @onelayergui5_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function varargout = onelayergui5_OutputFcn(hObject, eventdata, handles)
