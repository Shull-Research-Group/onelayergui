function varargout = condfig5(varargin)
%CONDFIG M-file for condfig5.fig
%      CONDFIG5, by itself, creates a new CONDFIG5 or raises the existing
%      singleton*.
%
%      H = CONDFIG5 returns the handle to a new CONDFIG5 or the handle to
%      the existing singleton*.
%
%      CONDFIG5('Property','Value',...) creates a new CONDFIG5 using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to CONDFIG_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      CONDFIG5('CALLBACK') and CONDFIG5('CALLBACK',hObject,...) call the
...
% Last Modified by GUIDE v2.5 04-Nov-2015 15:14:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @condfig5_OpeningFcn, ...
                   'gui_OutputFcn',  @condfig5_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
function condfig5_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = condfig5_OutputFcn(hObject, eventdata, handles)
...
function condfig3_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end

function condfig3_CloseRequestFcn(hObject, eventdata, handles)
if handles.refit
